<#
    ...
    .DESCRIPTION
        ...
        This script tests the ArrangoDB SLEEP() operation to help determine a good range of timings for
    ...
    .EXAMPLE
        ...
        .\15-deactivate-sql-timing-ops-test.ps1 -BotUUID f14d60cd-67b9-44ec-8f41-b5ea5137413c
